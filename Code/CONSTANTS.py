...
SUCCESFUL = "SUCCESFUL"
PARTIALLY_SUCCESFUL = "PARTIALLY_SUCCESFUL"
NOT_SUCCESFUL = "NOT_SUCCESFUL"

WAS_COPIED = [SUCCESFUL, PARTIALLY_SUCCESFUL, NOT_SUCCESFUL]

YES = [SUCCESFUL, SHOULD_BE_COPIED]
